...
namespace Best.SignalR
{
    ...
    public sealed class HubConnection : Best.HTTP.Shared.Extensions.IHeartbeat
    {
        ...
        public Subscription GetSubscription(string methodName) => this.subscriptions.TryGetValue(methodName, out var subscribtion) ? subscribtion : null;

        public Type GetItemType(long invocationId) => this.invocations.TryGetValue(invocationId, out var def) ? def.returnType : null;
